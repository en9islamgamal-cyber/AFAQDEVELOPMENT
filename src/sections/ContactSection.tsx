...
const ContactSection = ({ className = '' }: ContactSectionProps) => {
  ...
  return (
    <section
      id="contact"
      ref={sectionRef}
      className={`relative bg-navy-800 py-20 lg:py-32 ${className}`}
    >
      <div className="px-6 lg:px-[7vw]">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-16">
          {/* Left Column - Text + Contact Info */}
          <div ref={leftColRef} className="lg:w-[45%] lg:pt-8">
            ...
            <p className="text-body text-gray-cool mb-10 leading-relaxed max-w-md">
              Tell us what you're planning. We'll respond within two business days 
              with a clear scope and next steps.
            </p>
            ...
            <div className="space-y-5 mb-10">
              {contactInfo.map((item, index) => (
                <div key={index} className="flex items-center gap-4">
                  ...
                  <div>
                    <span className="block text-xs text-gray-cool uppercase tracking-wider">
                      {item.label}
                    </span>
            ...
            <p className="text-sm text-gray-cool">
              Prefer email? Attach your scope and we'll review it immediately.
            </p>
          </div>

          {/* Right Column - Form */}
          <div ref={formCardRef} className="lg:w-[55%] lg:pl-8">
              ...
              {isSubmitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                      <label className="block text-xs text-gray-cool mb-2 uppercase tracking-wider">
                        Name
                      </label>
                      <Input
                        type="text"
                        ...
                        required
                        className="bg-white/5 border-white/10 text-white placeholder:text-gray-cool/50 focus:border-primary"
                      />
                    </div>
                    <div>
                      <label className="block text-xs text-gray-cool mb-2 uppercase tracking-wider">
                    ...
                    <div>
                      ...
                      >
                        ...
                        <SelectContent className="bg-navy-800 border-white/10">
                          ...
                          <SelectItem value="fitout">Interior Fit-out</SelectItem>
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      rows={4}
                      required
                      className="bg-white/5 border-white/10 text-white placeholder:text-gray-cool/50 focus:border-primary resize-none"
                    />
                  </div>
